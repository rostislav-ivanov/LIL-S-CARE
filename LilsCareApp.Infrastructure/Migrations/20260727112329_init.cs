        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpirationDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, comment: "Expiration Date of Promo Code"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, comment: "The date when the review was created.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, comment: "Date of Order Creating"),
                    ...
                    DateShipping = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true, comment: "Date of Shipping Creating"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "45fbe739-6be0-429d-b44b-1ce6cf7eeef", 0, "d0adb272-4663-4ff6-acea-b26beb922e57", "admin@mail.com", true, "Admin", null, "Adminov", false, null, "ADMIN@MAIL.COM", "ADMIN@MAIL.COM", "AQAAAAIAAYagAAAAECY38zGGD48Ngy/PGwmRKnlHvKGFQgGBy9/QaSPApU/2CZqz9MCodRJNrN48yFlC+g==", null, false, "42f81cf4-d65e-4958-9f0c-42382d7d4a4a", false, "admin@mail.com" },
                    { "85fbe739-6be0-429d-b44b-1ce6cf7eeef", 0, "34d26c23-04a6-4a4a-a785-a7e15a273961", "test@softuni.bg", true, "Test", null, "Testov", false, null, "TEST@SOFTUNI.BG", "TEST@SOFTUNI.BG", "AQAAAAIAAYagAAAAENzNoyhha/QRxqzurVhXqeoNL6fnLhE3lxQUk0pZga2oanoAqMU+3WAr5DcLwVfkNg==", null, false, "6be0fd47-50bb-45f5-bd8f-20a168b6c658", false, "test@softuni.bg" }
                });
