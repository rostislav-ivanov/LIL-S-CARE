...
namespace LilsCareApp.Infrastructure.Data.DataConfiguration
{
    internal class ShippingProvidersConfiguration : IEntityTypeConfiguration<ShippingProvider>
    {
        ...
        {
            new ShippingProvider { Id = 1, Name = "До офис Еконт / Спиди", Price = 6.50m, Description = "2-3 работни дни" },
            new ShippingProvider { Id = 2, Name = "До адрес - Еконт" , Price = 8.50m, Description = "2-3 работни дни" },
        };
